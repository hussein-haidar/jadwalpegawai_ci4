<div class="box box-primary box-solid">
    ...
    <!-- /.box-header -->
    <div class="box-body">
        <form method="post" action="<?= base_url('pegawai_laporan_mingguan/filter_by_date') ?>">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="end_date" id="end_date" class="form-control" value="<?= $end_date ?>" required>
                    </div>
                </div>
            ...
            <?php if ($start_date && $end_date) : ?>
                <a href="<?= base_url('pegawai_laporan_mingguan/cetak_laporan') . '?start_date=' . $start_date . '&end_date=' . $end_date ?>" class="btn btn-sm btn-success" target="_blank">
                    <i class="fa fa-print" aria-hidden="true"></i> Cetak Data
                </a>
                <a href="<?= base_url('pegawai_laporan_mingguan/reset_filter') ?>" class="btn btn-sm btn-secondary">
