<div class="box box-primary box-solid">
    <div class="box-header">
        <a href="<?= base_url('pegawai_kelola_data/data_jadwal') ?>" class="btn-sm">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-12">
                <iframe src="<?= base_url('dokumenkegiatan/' . $data_jadwal['dokumen_kegiatan']) ?>" width="100%" height="800px"></iframe>
            </div>
        </div>
    </div>
</div>